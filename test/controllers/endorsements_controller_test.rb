...
class EndorsementsControllerTest < ActionController::TestCase
  ...
  test "should create endorsement" do
    assert_difference('Endorsement.count') do
      post :create, endorsement: { category: @endorsement.category, firstname: @endorsement.firstname, lastname: @endorsement.lastname, organization: @endorsement.organization, ranking: @endorsement.ranking, title: @endorsement.title }
    end
  ...
  test "should update endorsement" do
    patch :update, id: @endorsement, endorsement: { category: @endorsement.category, firstname: @endorsement.firstname, lastname: @endorsement.lastname, organization: @endorsement.organization, ranking: @endorsement.ranking, title: @endorsement.title }
    assert_redirected_to endorsement_path(assigns(:endorsement))
  end
